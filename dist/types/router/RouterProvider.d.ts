...
declare function RouterProvider({ routers, isPermit, levelOrRole, }: RouterProviderProps): JSX.Element;
export default RouterProvider;
export declare const BrowserRouterProvider: typeof RouterProvider;
export declare function HashRouterProvider({ routers, isPermit, levelOrRole, }: RouterProviderProps): JSX.Element;
